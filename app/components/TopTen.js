...
// ============================================
// TOP 10 THIS WEEK
// Top 3 get featured treatment — bigger, bolder
// Bottom 7 are a compact ranked list
// ============================================

const TOP_TEN = [
  { rank: 1, title: 'Нощен Влак', country: 'BG', year: '2023', type: 'Short Film', rating: '4.8', director: 'Elena Borisova' },
  { rank: 2, title: 'Последниот Воз', country: 'MK', year: '2024', type: 'Short Film', rating: '4.6', director: 'Aleksandar Donev' },
  { rank: 3, title: 'Valuri', country: 'RO', year: '2024', type: 'Short Film', rating: '4.5', director: 'Ioana Petre' },
  { rank: 4, title: 'Bela Soba', country: 'SRB', year: '2024', type: 'Music Video', rating: '4.3', director: 'Milena Janković' },
  { rank: 5, title: 'Tihi Grad', country: 'HR', year: '2024', type: 'Short Film', rating: '4.2', director: 'Luka Horvat' },
  { rank: 6, title: 'Senka', country: 'BA', year: '2023', type: 'Short Film', rating: '4.1', director: 'Amra Čehić' },
  { rank: 7, title: 'Φως', country: 'GR', year: '2024', type: 'Music Video', rating: '4.0', director: 'Nikos Papadopoulos' },
  { rank: 8, title: 'Srebrna Nit', country: 'SRB', year: '2023', type: 'Short Film', rating: '3.9', director: 'Stefan Popović' },
  { rank: 9, title: 'Drita', country: 'KOS', year: '2024', type: 'Short Film', rating: '3.8', director: 'Ardita Krasniqi' },
  { rank: 10, title: 'Planina', country: 'MNE', year: '2023', type: 'Short Film', rating: '3.7', director: 'Nikola Đurović' },
];

// Rank number style — big and dramatic
...
// Poster placeholder
function Poster({ width, height, rank, hovered }) {
  return (
    <div style={{
...
export default function TopTen() {
  ...
  const top3 = TOP_TEN.slice(0, 3);
  const rest = TOP_TEN.slice(3);
  ...
  return (
    <section style={{ padding: '0 80px 80px' }}>
        ...
        {top3.map((film) => (
          <div
            ...
            style={{
              ...
              transform: hoveredRank === film.rank ? 'translateY(-6px)' : 'translateY(0)',
            }}
          >
            <Poster
              width="100%"
            ...
            <div style={{ padding: '12px 0 0' }}>
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  color: '#c9a84c',
                  textShadow: hoveredRank === film.rank
                    ? '0 0 16px rgba(201,168,76,0.9), 0 0 32px rgba(201,168,76,0.5)'
                    : 'none',
                }}>
                  #{film.rank}
                </span>
                <span style={{
                  fontSize: '10px', letterSpacing: '2px', color: '#3a3020',
                  textTransform: 'uppercase', fontWeight: '500',
                }}>
                  {film.country}
                </span>
                <span style={{
                  fontSize: '10px', color: '#c9a84c', letterSpacing: '1px', marginLeft: 'auto',
                }}>
                  ★ {film.rating}
                </span>
              </div>
              ...
              <div style={{
                ...
                textShadow: hoveredRank === film.rank
                  ? '0 0 8px rgba(255,140,0,0.8), 0 0 20px rgba(255,80,0,0.5), 0 0 40px rgba(200,0,0,0.3)'
                  : 'none',
                animation: hoveredRank === film.rank ? `flameBurn${film.rank} 1.5s ease-in-out infinite` : 'none',
              ...
              <div style={{
                ...
                {film.director} &middot; {film.year} &middot; {film.type}
              </div>
            </div>
          </div>
        ))}
      ...
      {/* Divider */}
      <div style={{ height: '0.5px', background: '#1a1610', margin: '32px 0' }} />

      {/* BOTTOM 7 — compact list */}
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
        {rest.map((film, i) => (
          <div
            ...
            style={{
              display: 'grid',
              gridTemplateColumns: '48px 100px 1fr auto',
              gap: '16px',
          ...
          >
            ...
            <div style={{
              ...
              textShadow: hoveredRank === film.rank
                ? '0 0 12px rgba(201,168,76,0.8), 0 0 24px rgba(201,168,76,0.4)'
                : 'none',
            }}>
              {film.rank}
            </div>
            ...
            <div>
              <div style={{
                fontSize: '14px', fontWeight: '600', color: '#d0c8b0',
                letterSpacing: '0.3px', marginBottom: '3px',
                transition: 'color 0.2s ease',
                ...(hoveredRank === film.rank && { color: '#f0e8d0' }),
              }}>
                {film.title}
              </div>
              <div style={{
                ...
                {film.director} &middot; {film.country} &middot; {film.year} &middot; {film.type}
              </div>
            </div>

            {/* Rating */}
            <div style={{
              fontSize: '13px', color: '#c9a84c', letterSpacing: '1px',
        ...
        @keyframes flameBurn1 {
          0%   { color: #f0e8d0; text-shadow: none; }
          ...
          100% { color: #f0e8d0; text-shadow: none; }
        }
